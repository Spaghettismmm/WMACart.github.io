...
<?php 
			...
			if (isset($_REQUEST['submitted'])) {
				  ...
				  //Check for a valid email number
					...
					else{ $errors[] = 'Your email number can not contain that character.';}
					} 
				...
				if (isset($_REQUEST["submitted"])) {
				  // Print any error messages. 
					  ...
					  echo '</ul><h3>Your mail could not be sent due to input errors.</h3><hr/>';}
					   ...
					   <hr/><p4>Below is the message that you sent.</p4>'; 
					  echo "Message from " . $firstname . " " . $lastname . " <br />Email/Phone: ".$email." <br />";
					  }
				}
				//End of errors array
?> 
